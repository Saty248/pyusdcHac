...
const ReferralCodeRedirect = () => {
  ...
  const onTermsAndConditionsClicked = () => { return; }

  const onPrivacyPolicyClicked = () => { return; }
    ...
    <Fragment>
      ...
      {!doesCodeExist && (
        <div className='w-screen h-screen flex items-center justify-center flex-col gap-5 text-[#222222]'>
          ...
          <p className='max-w-[400px] text-center'>It seems like you've taken a wrong turn. The referral code you entered doesn't match any in our records. Double-check the code and make sure there are no typos. Good luck!</p>
          <div className='text-[#222222] p-4 rounded hover:text-white cursor-pointer hover:bg-[#222222]' style={{ border: "1px solid #222222" }} onClick={() => router.replace('/')}>Go to login</div>
        </div>
      )}
        ...
        <div className='h-screen w-screen flex'>
          <div className='flex-1 bg-white flex items-center justify-center'>
            <div className='flex flex-col gap-[15px] px-[30px] py-[40px] items-center justify-center max-w-[577px]'>
              ...
              <p className='font-normal text-base text-[#222222] text-center px-[44px]'>Join SkyTrade today and turn your air rights into a lucrative opportunity! 🚀✨</p>
            </div>
          </div>
          <div
            className='relative bg-[#E9F5FE] max-sm:bg-[white] h-screen w-screen flex flex-1 items-center justify-center overflow-hidden'
          >
            <form
            ...
            >
              ...
              <p className='text-sm text-light-grey text-center'>Sign up to get rewarded with 50 credit</p>
