...
const Item = ({ title, text, imageUrl, link }) => {
    return (
        <Link href={link} className="bg-no-repeat bg-center bg-cover rounded-[20px] min-w-[168px] flex-1 py-[16px] px-[18px]" style={{ backgroundImage: `url(${imageUrl})`, boxShadow: '0px 12px 34px -10px #3A4DE926' }}>
