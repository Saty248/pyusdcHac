...
const Item = ({ title, text, imageUrl, link, style }) => {
    return (
        <Link href={link} className={`${style || ''} bg-no-repeat bg-center bg-cover rounded-[20px] min-w-[168px] flex-1 py-[16px] px-[18px]`} style={{ backgroundImage: `url(${imageUrl})`, boxShadow: '0px 12px 34px -10px #3A4DE926' }}>
                ...
                <div className="w-full h-full flex flex-col">
                    ...
                    <section className="relative w-full h-full overflow-y-scroll py-[23px] px-[14px] flex mb-[78.22px] md:mb-0 flex-col items-center">
                        ...
                        <div className="flex gap-[11px] w-full h-full flex-wrap">
                            <Item title={'Buy Airspace'} imageUrl={'/images/buy.jpg'} link={'/homepage/buy'} style={'bg-right'} />
