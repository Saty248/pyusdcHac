            ...
            <div style={{width: "calc(100vw - 257px)", height: "100vh"}} className=" bg-white overflow-y-auto">
                ...
                <div className="bg-white py-16 px-10 mx-auto" style={{maxWidth: "1183px", height: "1526px", borderTop: "2px solid #F0F0FA"}}>
                    ...
                    <div className="flex flex-row items-end gap-20">
                        <Image src="/images/uav.png" className="w-1/2" alt="a picture of UAV" width={525} height={350} />
                        <div className="w-1/2">
                            <p className="text-light-dark mb-1.5"><span className="font-semibold">UAV Nickname:</span> Air Drone </p>
                            <p className="text-light-dark mb-1.5"><span className="font-semibold">Device Type:</span> Domestic Made</p>
                            <p className="text-light-dark mb-1.5"><span className="font-semibold">UAV Model:</span> CX0007TY</p>
                            <p className="text-light-dark mb-1.5"><span className="font-semibold">UAV Manufacturer:</span> DJI</p>
                            <p className="text-light-dark mb-1.5"><span className="font-semibold">Serial Number:</span> S475635RDT54</p>
                        ...
                        {reviews &&
                            <div>
                                ...
                                <div className="overflow-y-auto">
                                    <div style={{width: "695px"}} className="bg-white pt-6 mx-auto overflow-y-auto">
