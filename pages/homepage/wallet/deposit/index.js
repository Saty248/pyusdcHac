    ...
    return <div className="flex flex-row mx-auto" style={{maxWidth: "1440px"}}>
        ...
        <div style={{width: "1183px", height: "100vh"}} className="overflow-y-auto">
            ...
            <div className="rounded mx-auto mt-8 mb-5 bg-white p-10" style={{width: "940px", height: "748px"}}>
                ...
                <div className="px-7">
                    <p className="font-semibold mt-12">Select Payment Method</p>
                    ...
                    <div className="relative mt-8">
                        ...
                        <p className="absolute text-light-brown top-10 right-2">Min $ <span>20.00</span></p>
                    </div>
                    <div className="flex flex-row justify-center items-center mt-8 gap-5">
                        <button className="bg-dark-blue rounded-md text-white transition-all duration-500 ease-in-out hover:bg-blue-600" style={{width: "210px", height: "42px"}}>Deposit</button>
                    </div>
                    <div className="mt-10">
