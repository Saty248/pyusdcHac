...
const Wallet = () => {
    ...
    return <div className="flex flex-row mx-auto" style={{maxWidth: "1440px"}}>
        ...
        <div style={{width: "1183px", height: "100vh"}} className="overflow-y-auto">
            ...
            <div className="rounded mx-auto mt-8 mb-5 bg-white p-10" style={{width: "940px", height: "748px"}}>
                ...
                <div className="px-7">
                    <p className="font-semibold mt-12">Select Withdrawal Method</p>
                    ...
                    <button onClick={addCardHandler} className="flex flex-row items-center gap-2 mt-8 font-medium text-dark-blue">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="809" className="mt-5" height="2" viewBox="0 0 809 2" fill="none">
                        <path d="M0 1L809 0.999929" stroke="#0653EA" stroke-width="0.35"/>
                    </svg>
                    <div className="relative mt-8">
                        <label htmlFor="amount" className="text-xl text-light-brown">Amount</label>
                        <input className="rounded ps-4 pt-1 placeholder:font-medium focus:outline-blue-200" type="number" placeholder="0.00" id="amount"  name="amount" style={{width: "810px", height: "37px", border: "0.35px solid #0653EA"}} />
                        <p className="text-sml absolute text-light-brown top-2 right-0">Withdrawable Balance $ <span>4000.85</span></p>
                        <p className="absolute text-light-brown top-10 right-2">Min $ <span>20</span></p>
                    </div>
                    <div className="flex flex-row justify-center items-center mt-8 gap-5">
                        <button className="bg-dark-blue rounded-md text-white transition-all duration-500 ease-in-out hover:bg-blue-600" style={{width: "210px", height: "42px"}}>Withdraw</button>
                    </div>
                    <div className="mt-10">
                        <p className="text-sml text-light-brown">1. Maximum per transaction is $ 2,000.00</p>
                        <p className="text-sml text-light-brown">2. Minimum per transaction is $ 20.00</p>
                        <p className="text-sml text-light-brown">3. Withdrawal is free, no transaction fees.</p>
                    </div>
                </div>
