...
const PilotProfileModal = (props) => {
  ...
  return (
    ...
    >
      <div>
        <div className='mx-auto mt-20 flex flex-row items-center justify-center gap-36'>
          <Image
            src='/images/pilot-picture.png'
          ...
          <div>
            <p className='text-dark-brown'>
              <span className='font-semibold'>Name: </span>Eleanor Pena
            </p>
            <p className='text-dark-brown'>
              <span className='font-semibold'>FAA Tracking Number: </span>
              98573645
            </p>
            <p className='text-dark-brown'>
              <span className='font-semibold'>Flight Time: </span>156 hrs
            </p>
            <p className='text-dark-brown'>
            ...
            <p className='text-dark-brown'>
              <span className='font-semibold'>UAVs: </span>UAV 1, UAV
            </p>
            <p className='text-dark-brown'>
              <span className='font-semibold'>Pilot License Number: </span>
              27TDR875
            </p>
          </div>
        </div>
        <div className='mt-10 flex flex-row justify-center gap-2.5'>
          <button
      ...
      <div className='mt-10'>
        ...
        {reviews && (
          <div className='mx-auto w-8/12' style={{ height: '450px' }}>
            ...
            <div className='overflow-y-scroll' style={{ height: '220px' }}>
              <div className='overflow-y-auto bg-white pt-6'>
                <div className='mx-auto rounded bg-light-blue p-2.5'>
                  <p>
                    “Lorem ipsum dolor sit amet, consectetur adipiscing et, sed
                    do eiusmod tempor incididunt ut Duis aute irure dolor in
                    reprehe nderit in voluptate velit esse cillum do lore eu
                    fugiat nulla pariatu labore t enim ad minima ve niam, quis
        ...
        {flightHistory && (
          <div className='mx-auto overflow-y-auto' style={{ height: '400px' }}>
            <div
            ...
            >
              <div className='flex flex-row justify-between'>
                ...
                <div className='relative'>
                  <p className='flex flex-row items-center'>3:05 hrs</p>
                  <div className='flex flex-row items-center'>
                    <Image
                      src='/images/Star.png'
                      alt='star icon'
