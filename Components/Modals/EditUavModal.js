    ...
    return <div className="bg-white rounded px-12 fixed z-20 " style={{width: "886px", height: "1001px", 
        ...
        right: "277px" 
            ...
            <div className="relative" style={{width: "290px"}}>
                <p className="text-light-brown font-medium">Upload an Image</p>
                <Image src="/images/uav.png" alt="a picture of UAV" width={290} height={217} />
                <div className="flex flex-row gap-2 absolute right-2 bottom-2">
                    <button>
                        <svg xmlns="http://www.w3.org/2000/svg" className="bg-white hover:bg-bleach-blue transition-all duration-500 ease-in-out p-1 rounded" width="27" height="27" viewBox="0 0 14 14" fill="none">
                    ...
                    <button>
                        <svg xmlns="http://www.w3.org/2000/svg" className="bg-white hover:bg-bleach-blue transition-all duration-500 ease-in-out p-1 rounded" width="27" height="27" viewBox="0 0 17 17" fill="none">
            ...
            <form className="mt-7">
                ...
                <p className="mt-2.5 text-light-brown text-sm font-semibold">Not sure? Contact your UAS manufacturer or see if your drone is listed <span> <a href="https://uasdoc.faa.gov/listDocs" target="_blank" className="text-dark-blue underline">here</a> </span> </p>
                <div className="flex flex-row items-center justify-between">
                    <div className="mt-7">
                        <label htmlFor="nickname" className="text-light-brown font-medium">UAV Nickname*</label> <br />
                        <input type="text" name="nickname" id="nickname" defaultValue="Air Drone" className="rounded ps-5 mt-2.5 focus:outline-blue-200" style={{width: "383px", height: "37px", border: "0.3px solid rgba(6, 83, 234, 0.4)"}} />
                    </div>
                ...
                <div className="flex flex-row items-center justify-between">
                    <div className="mt-7">
                        ...
                        <input type="text" name="manufacturer" id="manufacturer" defaultValue="DJI" className="rounded ps-5 mt-2.5 focus:outline-blue-200" style={{width: "383px", height: "37px", border: "0.3px solid rgba(6, 83, 234, 0.4)"}} />
                    </div>
                    <div className="mt-7">
                        <label htmlFor="model" className="text-light-brown font-medium">UAV Model*</label> <br />
                        <input type="text" name="model" id="model" defaultValue="CX0007TY" className="rounded ps-5 mt-2.5 focus:outline-blue-200" style={{width: "383px", height: "37px", border: "0.3px solid rgba(6, 83, 234, 0.4)"}} />
                    </div>
                </div>
                <div className="flex flex-row items-center gap-16">
                    <div className="mt-7">
                        <label htmlFor="serial number" className="text-light-brown font-medium">Serial Number*</label> <br />
                        <input type="text" name="serial number" id="serial number" defaultValue="S475635RDT54" className="rounded ps-5 mt-2.5 focus:outline-blue-200" style={{width: "383px", height: "37px", border: "0.3px solid rgba(6, 83, 234, 0.4)"}} />
                    </div>
                ...
                <div className="flex flex-row items-center justify-between">
                    <div className="mt-7">
                        ...
                        <input type="text" name="range" id="range" defaultValue="27 KM" className="rounded ps-5 mt-2.5 focus:outline-blue-200" style={{width: "383px", height: "37px", border: "0.3px solid rgba(6, 83, 234, 0.4)"}} />
                    </div>
                    <div className="mt-7">
                        <label htmlFor="battery range" className="text-light-brown font-medium">Battery Range*</label> <br />
                        <input type="text" name="battery range" id="battery range" defaultValue="45 mins" className="rounded ps-5 mt-2.5 focus:outline-blue-200" style={{width: "383px", height: "37px", border: "0.3px solid rgba(6, 83, 234, 0.4)"}} />
                    </div>
                </div>
                <div className="flex flex-row justify-center items-center mt-12 gap-5">
                    ...
                    <button className="bg-dark-blue rounded-md text-white text-sml transition-all duration-500 ease-in-out hover:bg-blue-600" style={{width: "120px", height: "40px"}}>Edit UAV</button>
                </div>
            </form>
        </div>
}
