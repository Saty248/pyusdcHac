const AdditionalAispaceInformation = () => {
    ...
    // top: "10px",
        ...
        <form className="px-10">
            <div className="px-14 pb-5 flex flex-row items-center justify-between gap-8">
                ...
                <input type="text" placeholder="AirSpace Title" style={{width: "383px", height: "27px"}} className="bg-light-blue ps-2 placeholder:text-sml placeholder:text-light-brown rounded-sm" name="AirSpace Title" />
            </div>
            <hr />
            ...
            <div className="px-14 pb-5 pt-2 flex flex-row items-center justify-start gap-8">
                ...
                <div className="flex flex-row justify-center -ms-2 items-center gap-2">
                    <input type="number" name="hour" min="1" placeholder="20" style={{width: "62px", height: "27px"}} className="bg-light-blue ps-2 placeholder:text-sml placeholder:text-light-brown rounded-sm" />
            ...
            <div className="flex flex-row justify-center items-center mt-8 gap-5">
                <button className="rounded-md text-blue" style={{border: "1px solid #0653EA", width: "120px", height: "40px"}}>Cancel</button>
