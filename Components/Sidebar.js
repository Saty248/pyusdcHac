...
const Sidebar = () => {
  ...
  const NavLink = (props) => {
    ...
    return (
      <Link
        ...
        className={`${
          isActive &&
          'border-s-2 border-dark-blue bg-gradient-to-r from-blue-400 to-white'
        } flex flex-row items-center gap-2 rounded-md p-2 hover:border-s-2 hover:border-dark-blue hover:bg-gradient-to-r hover:from-blue-400 hover:to-white`}
      >
        {props.children}
      </Link>
    );
  ...
  return (
    <Fragment>
      ...
      <aside
        className='relative border-e-2 bg-white pe-5'
      ...
      >
        ...
        <div className='ms-10 flex flex-col gap-2'>
          <NavLink href='/homepage/dashboard'>
            <svg
              ...
              viewBox='0 0 29 29'
              fill={`${
                asPath == '/homepage/dashboard' ? '#0653EA' : '#252530'
              }`}
            >
          ...
          <div className='relative flex cursor-default flex-row items-center gap-2 rounded-md p-2'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width='29'
              height='29'
              viewBox='0 0 29 29'
              fill={`${
                asPath.includes('/homepage/uavs') ? '#0653EA' : '#252530'
              }`}
            >
              <path
                d='M24.2272 12.845L18.5843 10.4163L17.3276 9.88458C17.1343 9.78792 16.9651 9.53417 16.9651 9.31667V5.61917C16.9651 4.45917 16.1072 3.08167 15.068 2.55C14.7055 2.36875 14.2705 2.36875 13.908 2.55C12.8809 3.08167 12.023 4.47125 12.023 5.63125V9.32875C12.023 9.54625 11.8538 9.8 11.6605 9.89667L4.77301 12.8571C4.01176 13.1713 3.39551 14.1258 3.39551 14.9475V16.5425C3.39551 17.5696 4.16884 18.0771 5.12342 17.6663L11.1772 15.0563C11.6484 14.8508 12.0351 15.1046 12.0351 15.6242V16.9654V19.1404C12.0351 19.4183 11.878 19.8171 11.6847 20.0104L8.88134 22.8258C8.59134 23.1158 8.45842 23.6838 8.59134 24.0946L9.13509 25.7379C9.35259 26.4508 10.1622 26.7892 10.8268 26.4508L13.7026 24.0342C14.1376 23.6596 14.8505 23.6596 15.2855 24.0342L18.1613 26.4508C18.8259 26.7771 19.6355 26.4508 19.8772 25.7379L20.4209 24.0946C20.5538 23.6958 20.4209 23.1158 20.1309 22.8258L17.3276 20.0104C17.1222 19.8171 16.9651 19.4183 16.9651 19.1404V15.6242C16.9651 15.1046 17.3397 14.8629 17.823 15.0563L23.8768 17.6663C24.8313 18.0771 25.6047 17.5696 25.6047 16.5425V14.9475C25.6047 14.1258 24.9884 13.1713 24.2272 12.845Z'
            ...
            <div
              className='absolute right-0 me-1.5 flex flex-col items-center justify-center px-2 py-2.5 font-semibold'
          ...
          <div className='relative flex cursor-default flex-row items-center gap-2 rounded-md p-2'>
            <svg
              ...
              height='29'
              viewBox='0 0 29 29'
              fill={`${asPath == '/homepage/pilots' ? '#0653EA' : '#252530'}`}
            >
          ...
          <NavLink href='/homepage/wallet'>
            <svg
              ...
              viewBox='0 0 29 29'
              fill={`${
                asPath.includes('/homepage/wallet') ? '#0653EA' : '#252530'
              }`}
            >
              <path
                fillRule='evenodd'
                clipRule='evenodd'
                d='M25.3874 12.2907L25.3906 16.6684C25.3597 17.0854 25.32 17.502 25.2714 17.9177C25.1901 18.613 24.6249 19.1739 23.9151 19.2532C21.6921 19.5016 19.3916 19.5016 17.1686 19.2532C16.4588 19.1739 15.8936 18.613 15.8123 17.9177C15.5467 15.6473 15.5467 13.3536 15.8123 11.0831C15.8936 10.3878 16.4588 9.82699 17.1686 9.74766C19.3916 9.49921 21.6921 9.49921 23.9151 9.74766C24.6249 9.82699 25.1901 10.3878 25.2714 11.0831C25.3184 11.485 25.3571 11.8876 25.3874 12.2907ZM20.5418 12.6879C19.5408 12.6879 18.7293 13.4994 18.7293 14.5004C18.7293 15.5014 19.5408 16.3129 20.5418 16.3129C21.5429 16.3129 22.3543 15.5014 22.3543 14.5004C22.3543 13.4994 21.5429 12.6879 20.5418 12.6879Z'
              />
            ...
            <span
              className={`${
                asPath.includes('/homepage/wallet')
                  ? 'text-dark-blue'
                  : 'text-light-brown'
              } font-semibold`}
            >
        ...
        <button
          ...
          className='absolute bottom-2 ms-10 flex w-10/12 flex-row gap-2 rounded-md p-2 hover:border-s-2 hover:border-dark-blue hover:bg-gradient-to-r hover:from-blue-400 hover:to-white'
        >
          <svg
            xmlns='http://www.w3.org/2000/svg'
            width='29'
          ...
          >
            <path
              d='M20.3 2.41602H17.1583C13.2917 2.41602 10.875 4.83268 10.875 8.69935V13.5931H18.4271C18.9225 13.5931 19.3333 14.0039 19.3333 14.4993C19.3333 14.9948 18.9225 15.4056 18.4271 15.4056H10.875V20.2993C10.875 24.166 13.2917 26.5827 17.1583 26.5827H20.2879C24.1546 26.5827 26.5712 24.166 26.5712 20.2993V8.69935C26.5833 4.83268 24.1667 2.41602 20.3 2.41602Z'
              fill='#252530'
            />
            <path
              d='M5.51023 13.5937L8.01148 11.0925C8.19273 10.9112 8.27732 10.6816 8.27732 10.4521C8.27732 10.2225 8.19273 9.98081 8.01148 9.81164C7.66107 9.46122 7.08107 9.46122 6.73065 9.81164L2.68273 13.8596C2.33232 14.21 2.33232 14.79 2.68273 15.1404L6.73065 19.1883C7.08107 19.5387 7.66107 19.5387 8.01148 19.1883C8.3619 18.8379 8.3619 18.2579 8.01148 17.9075L5.51023 15.4062H10.8752V13.5937H5.51023Z'
              fill='#252530'
            />
          </svg>
          <span className='font-semibold text-light-brown'>Log Out</span>
        </button>
      </aside>
    </Fragment>
  );
