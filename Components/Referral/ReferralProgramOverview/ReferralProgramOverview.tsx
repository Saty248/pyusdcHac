import { EarthIcon, GiftIcon, ShareIcon } from "@/Components/Icons";
...
const ReferralProgramOverview:React.FC<ReferralProgramOverviewProps> = ({ activeSection, section, isMobile }) => {
