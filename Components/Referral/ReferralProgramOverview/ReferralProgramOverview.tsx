    ...
    <Fragment>
      <div className="px-[40px] flex flex-col gap-[15px]">
        ...
        <div className="text-[#4285F4] text-[15px] font-normal">
          ...
          <li>You earn <span className="font-bold text-[20px]">+50 SKY Points</span> for each successful referral registration when your friend creates an account and claims a property.</li>
          <li>Your friend also gets <span className="font-bold text-[20px]">+50 SKY Points</span> upon creating an account and claiming a property.</li>
