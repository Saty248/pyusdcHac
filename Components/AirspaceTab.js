...
const AirspaceTab = (props) => {
    return <button key={props.id} onClick={props.viewAirspace} className="bg-red-500 mt-8 transition-all duration-500 ease-in-out hover:bg-blue-100" style={{width: "299px", height: "100px", borderRadius: "3px", border: "1px solid blue"}}>
