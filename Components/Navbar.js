...
const Navbar = (props) => {
    ...
    <nav className="container mx-auto my-0 flex flex-row justify-between items-center">
        ...
        <div className="flex flex-row justify-center items-center me-5 cursor-pointer">
            ...
            <div onClick={() => router.push("/homepage/settings")} className="me-5 ms-2">
                ...
                <div className="me-1.5 flex flex-row items-center justify-center font-semibold gap-1 bg-bleach-green" style={{width: "45px", height: "12px", borderRadius:"3px", }}>
