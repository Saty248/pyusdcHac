...
const MyAirspaceTab: React.FC<MyAirspaceTabProps> = (props) => {
  return (
    <button
      onClick={props.viewMyAirspace}
    ...
    >
      ...
      >
        ...
        {props.propertyStatus !== "NotVerified" && (
          <div
            className="me-1.5 mt-5 flex flex-row items-center justify-center gap-1 p-2 font-semibold"
            style={{
              height: "21px",
              borderRadius: "3px",
      ...
      <div className="ms-2 text-start text-xs text-light-brown">
        <p>
