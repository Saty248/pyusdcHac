    ...
    return <>
        ...
        <div className="flex flex-row justify-center" style={{width: "340px", height: "100%", background: "linear-gradient(180deg, #0653EA, white)"}}>
            ...
            {props.myAirspace && <div className="bg-white flex overflow-y-auto flex-col items-center" style={{width: "99%", height: "100%", marginTop: "2px"}}>
                        <button onClick={async () => {await verificationCheck(); newAirspaceModalHandler();}} className="text-sm bg-milk mx-auto mt-5 flex flex-row justify-center items-center gap-2 font-medium text-light-dark rounded transition-all duration-500 ease-in-out hover:bg-blue-200 py-2" style={{width: "205px"}}>
