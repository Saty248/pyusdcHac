...
const Airspaces = (props) => {
    return <div className="ms-5 bg-white" style={{width: "340px", height: "860px", borderRadius: "5px"}}>
        <div className="flex flex-row">
            <button onClick={props.showAllAirspace} className={`${props.airspace == "all" && "bg-blue text-white"} font-bold hover:bg-blue hover:text-white`} style={{width: "170px", height: "40px", borderRadius: "5px 0px 0px 0px"}}>Airspaces</button>
            <button onClick={props.showMyAirspace} className={`${props.airspace == "mine" && "bg-blue text-white"} font-bold hover:bg-blue hover:text-white`} style={{width: "170px", height: "40px", borderRadius: "0px 5px 0px 0px"}}>My Airspaces</button>
        </div>
        <div className="flex flex-row justify-center" style={{width: "340px", height: "750px", background: "linear-gradient(180deg, #0653EA, white)"}}>
            {props.allAirspace && <div className="bg-white flex overflow-y-auto flex-col items-center" style={{width: "99%", height: "750px", marginTop: "2px"}}>
                {props.airSpaces.map(airspace => {
                    return <button key={airspace.id} onClick={props.viewAirspace} className="bg-white mt-8" style={{width: "299px", height: "100px", borderRadius: "3px", border: "1px solid blue"}}>
                        ...
                        <div className="flex flex-row items-center mt-2 text-sm ms-2">
                            <p>4.5</p>
        ...
        <div className="bg-white rounded-b-md text-center flex flex-row items-center" style={{width: "100%", height: "70px"}}>
