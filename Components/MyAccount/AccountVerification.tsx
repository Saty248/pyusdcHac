      ...
      {KYCStatusId === StatusTypes.NotAttempted && (
        <div className="flex w-full rounded-[30px] gap-[15px] bg-white" style={{ boxShadow: "0px 12px 34px -10px #3A4DE926" }} >
          <div className="md:w-[50%]  p-6  flex flex-col justify-center items-center md:gap-6 gap-4">
            ...
            <p className="text-sm font-normal text-[#838187] text-center leading-6">Your account is not verified. We verify the identity of our customers to assess potential risks, prevent fraud, and comply with legal and regulatory requirements. Complete your KYC to expedite the process and ensure swift approval. Plus,<span className="text-[#87878D] text-sm font-bold" > earn 10 SKY points </span> as a token of our appreciation! Don't delay - verify now and unlock the full potential of your airspace!</p>
              ...
              (
                ...
                <div>
                  <div>
                    ...
                    <p className="font-normal text-base text-[#87878D] mt-2">
                      Please <span className="font-bold">submit {formatTextToReadable(requestedDoc?.description)} </span>at your earliest convenience to enjoy full access to our services. Rest assured, your data is securely handled. If you have any questions, feel free to contact our support team. Thank you for your cooperation and patience
                    </p>
