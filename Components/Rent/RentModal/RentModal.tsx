  ...
  return (
      <LocalizationProvider dateAdapter={AdapterDayjs}>
        {!isMobile && (<Backdrop />)}
          ...
          className="touch-manipulation fixed top-1/2 md:top-44 left-1/2 sm:left-2/3 -translate-x-1/2 -translate-y-1/2 bg-white py-[30px] md:rounded-[30px] px-[29px] w-full max-h-screen h-screen md:max-h-[700px] md:h-auto md:w-[689px] z-[100] md:z-40 flex flex-col gap-[15px]"
        >
          <div
