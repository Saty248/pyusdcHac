stroke="#4285F4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M15.3179 23.3574C14.6745 23.4494 14.0694 23.7187 13.5704 24.1352C13.0714 24.5517 12.6982 25.0989 12.4927 25.7155C12.2872 26.3322 12.2574 26.9938 12.4068 27.6264C12.5561 28.259 12.8786 28.8375 13.3382 29.2971C13.7978 29.7567 14.3763 30.0792 15.0089 30.2286C15.6415 30.3779 16.3032 30.3482 16.9198 30.1426C17.5364 29.9371 18.0836 29.564 18.5001 29.065C18.9166 28.566 19.1859 27.9609 19.2779 27.3174" stroke="#4285F4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
...
export const ShoppingBagsIcon = ({ isActive }) => {
    return (
        <svg width="100%" height="100%" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15.5898 21.5063H5.58984C4.48527 21.5063 3.58984 20.6109 3.58984 19.5063V8.50635C3.58984 7.95406 4.03756 7.50635 4.58984 7.50635H14.5898C15.1421 7.50635 15.5898 7.95406 15.5898 8.50635V11.0063" stroke={isActive ? '#4285F4' : '#5D7285'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M9.58984 12.5063C9.58984 11.9541 10.0376 11.5063 10.5898 11.5063H20.5898C21.1421 11.5063 21.5898 11.9541 21.5898 12.5063V19.5063C21.5898 20.6109 20.6944 21.5063 19.5898 21.5063H11.5898C10.4853 21.5063 9.58984 20.6109 9.58984 19.5063V12.5063Z" stroke={isActive ? '#4285F4' : '#5D7285'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M12.5898 7.50635V6.50635C12.5898 4.84949 11.2467 3.50635 9.58984 3.50635V3.50635C7.93299 3.50635 6.58984 4.84949 6.58984 6.50635V7.50635" stroke={isActive ? '#4285F4' : '#5D7285'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M13.5898 14.5063L13.5898 15.5063C13.5898 16.6109 14.4853 17.5063 15.5898 17.5063V17.5063C16.6944 17.5063 17.5898 16.6109 17.5898 15.5063L17.5898 14.5063" stroke={isActive ? '#4285F4' : '#5D7285'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
}
...
export const WalletIcon = () => {
    return (
        <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle opacity="0.5" cx="21" cy="21" r="21" fill="#CCE3FC"/>
        <path d="M28 17V15C28 13.8954 27.1046 13 26 13H15C13.8954 13 13 13.8954 13 15V27C13 28.1046 13.8954 29 15 29H26C27.1046 29 28 28.1046 28 27V25" stroke="#4285F4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        <rect x="22" y="17" width="8" height="8" rx="1" stroke="#4285F4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        <circle cx="26" cy="21" r="1.5" fill="#4285F4"/>
        </svg>
...
export const WalletIconsidebar = ({ isActive }) => {
    return (
        <svg width="100%" height="100%" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="13.5898" y="8.77808" width="8" height="8" rx="1" stroke={isActive ? '#4285F4' : '#5D7285'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
...
export const LogoutIcon = ({ isActive }) => {
    return (
        <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15.5898 17.2013V19.7013C15.5898 20.8059 14.6944 21.7013 13.5898 21.7013H6.58984C5.48527 21.7013 4.58984 20.8059 4.58984 19.7013V5.70129C4.58984 4.59672 5.48527 3.70129 6.58984 3.70129H13.5898C14.6944 3.70129 15.5898 4.59672 15.5898 5.70129V8.76379M11.5898 12.7013H21.5898M21.5898 12.7013L19.0898 10.2013M21.5898 12.7013L19.0898 15.2013" stroke={isActive ? '#4285F4' : '#5D7285'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
}
...
export const ArrowCompressIcon = ({ isActive }) => {
    return (
        <svg width="100%" height="100%" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M7.70703 17.2885H14.7781M14.7781 17.2885L11.2426 13.7529M14.7781 17.2885L11.2426 20.824" stroke={isActive ? '#4285F4' : '#5D7285'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M27.5059 17.2885L20.4348 17.2885M20.4348 17.2885L23.9703 20.824M20.4348 17.2885L23.9703 13.7529" stroke={isActive ? '#4285F4' : '#5D7285'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
}
...
export const ArrowExpandIcon = ({ isActive }) => {
    return (
        <svg width="100%" height="100%" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M20.5 12L4.5 12M20.5 12L17 15.5M20.5 12L17 8.5M4.5 12L8 8.5M4.5 12L8 15.5" stroke={isActive ? '#4285F4' : '#5D7285'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
...
export const ShareIcon = ({ color }) => {
    return (
        <svg width="32" height="32" viewBox="0 0 63 64" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  export const GiftIconSm = () => {
    return (
        <svg  width="32" height="32"  viewBox="0 0 47 45" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  export const GiftIcon = () => {
    return (
        ...
        <ellipse opacity="0.5" cx="21" cy="21.5443" rx="21" ry="21.3178" fill="#CCE3FC"/>
        <rect x="11" y="16.1055" width="20" height="5.07566" rx="2" stroke="#4285F4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M13 21.1816H29V28.3178C29 29.4224 28.1046 30.3178 27 30.3178H15C13.8954 30.3178 13 29.4224 13 28.3178V21.1816Z" stroke="#4285F4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M21 16.1055V30.3173" stroke="#4285F4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M14 14.2722C14 13.0421 14.9972 12.0449 16.2273 12.0449H17.0705C19.2407 12.0449 21 13.8042 21 15.9745V15.9745C21 16.0468 20.9414 16.1055 20.869 16.1055H15.7866C14.7999 16.1055 14 15.3055 14 14.3188V14.2722Z" stroke="#4285F4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M28 14.2722C28 13.0421 27.0028 12.0449 25.7727 12.0449H24.9295C22.7593 12.0449 21 13.8042 21 15.9745V15.9745C21 16.0468 21.0586 16.1055 21.131 16.1055H26.2134C27.2001 16.1055 28 15.3055 28 14.3188V14.2722Z" stroke="#4285F4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    );
  };
...
export const PropertyIcon = () => {
    return (
        <svg width="100%" height="100%" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M4.18551 9.4818V21.3337C4.18551 22.4382 5.08094 23.3337 6.18551 23.3337H13.0003M4.18551 9.4818L12.2932 1.3741C12.6837 0.983574 13.3169 0.983575 13.7074 1.3741L20.792 8.45866M4.18551 9.4818L1.66699 12.0003M21.8151 9.4818V21.3337C21.8151 22.4382 20.9197 23.3337 19.8151 23.3337H13.0003M21.8151 9.4818L24.3337 12.0003M21.8151 9.4818L20.792 8.45866M20.792 8.45866V3.50032M13.0003 23.3337V16.2503" stroke="#4285F4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
...
export const WarningIcon = () => {
    return (
        <svg width="100%" height="100%" viewBox="0 0 24 25" preserveAspectRatio="none" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 7.5V13.5M21 12.5C21 17.4706 16.9706 21.5 12 21.5C7.02944 21.5 3 17.4706 3 12.5C3 7.52944 7.02944 3.5 12 3.5C16.9706 3.5 21 7.52944 21 12.5Z" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
...
export const LocationPointIcon = () => {
    return (
        <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="12" cy="10" r="3" stroke="#222222" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M19 9.75C19 15.375 12 21 12 21C12 21 5 15.375 5 9.75C5 6.02208 8.13401 3 12 3C15.866 3 19 6.02208 19 9.75Z" stroke="#222222" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
...
export const ChevronRightIcon = () => {
    return (
        <svg width="100%" height="100%" viewBox="0 0 10 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1.5 1L7.79289 7.29289C8.18342 7.68342 8.18342 8.31658 7.79289 8.70711L1.5 15" stroke="#222222" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
...
export const FailedIconwhite = () => {
    return (
        <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M32.032 64C49.696 64 64 49.664 64 32C64 14.336 49.696 4.95697e-06 32.032 6.36757e-06C14.336 7.78072e-06 3.8147e-06 14.336 3.8147e-06 32C3.8147e-06 49.664 14.336 64 32.032 64ZM32 6.4C46.144 6.4 57.6 17.856 57.6 32C57.6 46.144 46.144 57.6 32 57.6C17.856 57.6 6.4 46.144 6.4 32C6.4 17.856 17.856 6.40001 32 6.4Z" fill="white"/>
            <path d="M19.9443 38.8583C18.6998 40.1028 18.6998 42.1392 19.9443 43.3837C21.1888 44.6283 23.2253 44.6283 24.4698 43.3837L43.0481 24.8054C44.2926 23.5609 44.2926 21.5245 43.0481 20.28C41.8036 19.0355 39.7671 19.0355 38.5226 20.28L19.9443 38.8583Z" fill="white"/>
            <path d="M38.5223 43.3799C39.7668 44.6244 41.8033 44.6244 43.0478 43.3799C44.2923 42.1354 44.2923 40.099 43.0478 38.8544L24.4695 20.2762C23.225 19.0316 21.1885 19.0316 19.944 20.2761C18.6995 21.5207 18.6995 23.5571 19.944 24.8016L38.5223 43.3799Z" fill="white"/>
        </svg>
    )
}
export const ArrowLeftIcon = () => {
    return (
        <svg width="100%" height="100%" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M17 7H1M1 7L7 1M1 7L7 13" stroke="#222222" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
...
export const InfoIcon = () => {
    return (
        <svg width="100%" height="100%" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10 9.16667V13.3333M17.5 10C17.5 14.1421 14.1421 17.5 10 17.5C5.85786 17.5 2.5 14.1421 2.5 10C2.5 5.85786 5.85786 2.5 10 2.5C14.1421 2.5 17.5 5.85786 17.5 10Z" stroke="#222222" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
